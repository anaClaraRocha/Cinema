...
export default function App() {
  ...
  const [filme, setFilme] = useState([
    ...
    },
    {
      ...
      informaçoes:'Hora de Aventura ganhará uma adaptação aos cinemas em breve! A história acompanha Jake, o Cachorro, e seu melhor amigo, Finn, o Humano. Juntos eles enfrentam monstros, combatem o mal e salvam princesas na Ilha Ooo.',
    ...
    <View style={styles.borda}>
      <ImageBackground source={filme[route.params?.indice].fundo} style={styles.imgD42}>
        <View style={styles.brnArea2}>
          <TouchableOpacity onPress={() => navigation.navigate('Floresta')}><View style={styles.btnArea}><Image source={require('../../../../../assets/1486348526-arrow-back-backwards-repeat-previous_80453.png')} style={styles.imgD22}></Image></View></TouchableOpacity>
